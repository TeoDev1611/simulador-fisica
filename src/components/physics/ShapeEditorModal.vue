        ...
        >
          ...
          >
            ...
            <input
              ...
              class="h-1.5 bg-gray-200 dark:bg-gray-700 rounded-lg appearance-none accent-emerald-500 md:hidden"
            />
        ...
        >
          ...
          <div class="space-y-2">
            ...
            <input
              ...
              class="w-full h-3 bg-gray-200 dark:bg-gray-800 rounded-lg appearance-none cursor-pointer accent-emerald-500 md:hidden"
            />
          </div>
