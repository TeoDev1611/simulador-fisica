          ...
          <div v-show="showParametersPanel" class="mt-3 space-y-3">
            ...
            >
              ...
              <input
                ...
                type="number"
                step="0.1"
                class="w-16 md:w-full bg-transparent border border-gray-300 dark:border-gray-700 rounded-md px-1.5 py-1 text-xs font-mono text-emerald-700 dark:text-emerald-300 focus:border-emerald-800 dark:border-emerald-500 outline-none"
                @keydown.enter="addParameter"
              />
              <button
                @click="addParameter"
